...
function enhanceNexumNavigationV2() {
  ...
  search.innerHTML = '<span aria-hidden="true">⌕</span><input type="search" placeholder="Busca" aria-label="Busca global de empreendimentos"><section class="nav-global-results" hidden role="listbox"></section>';
  ...
  if (!mapFilters) filters.href = `${pageUrl('mapa.html')}?filtros=1`; filters.innerHTML = '<svg aria-hidden="true" width="24" height="24" viewBox="0 0 24 24" fill="none" focusable="false" xmlns="http://www.w3.org/2000/svg"><path d="M4 5H20L14 12V18L10 20V12L4 5Z" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"/></svg>';
